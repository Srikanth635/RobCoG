...
//by RH
// get the names and id of a GestureLandscape struct
void UManusBlueprintLibrary::GetGestureNameAndId(FGestureLandscapeData p_Gesture, FString &name, int64 &id ) {
	name = p_Gesture.Name;
	id = p_Gesture.Id;
}
