...
private:
	...
	UPROPERTY(EditAnywhere, Category = "Semantic Logger|World State Logger", meta = (editcondition = "bUseIndependently"))
	FSLLoggerDBServerParams DBServer;
	...
	bool ConnectDB(const FString& DBName, const FString& CollName, const FString& ServerIp,
