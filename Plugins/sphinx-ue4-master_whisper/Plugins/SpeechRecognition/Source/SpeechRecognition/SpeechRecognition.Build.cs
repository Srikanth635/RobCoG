	...
	public class SpeechRecognition : ModuleRules
	{
        ...
        public bool LoadWhisper(ReadOnlyTargetRules Target)
        {
            ...
            if ((Target.Platform == UnrealTargetPlatform.Win64) || (Target.Platform == UnrealTargetPlatform.Win32))
            {
                ...
                RuntimeDependencies.Add((Path.Combine(LibrariesPath, "whisper.dll"));

                PublicDelayLoadDLLs.Add("SDL2.dll");
                RuntimeDependencies.Add(Path.Combine(Path.Combine(LibrariesPath, "SDL2.dll"));

                PublicDelayLoadDLLs.Add("libopenblas.dll");
                RuntimeDependencies.Add(Path.Combine(LibrariesPath, "libopenblas.dll"));         
            }
            ...
            PublicDefinitions.Add(string.Format("WITH_WHISPER_BINDING={0}", isLibrarySupported ? 1 : 0));
